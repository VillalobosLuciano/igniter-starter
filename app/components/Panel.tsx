  ...
  return (
    <div className="mx-auto max-w-7xl rounded-lg px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl py-12 text-center lg:py-20">
        <h2 className="text-2xl font-extrabold text-gray-800 dark:text-white sm:text-4xl">
        ...
        <p className="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-400">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-gray-600 underline decoration-[#F37000] underline-offset-1 transition dark:text-gray-300 dark:hover:text-gray-200"
          >
            here.
          </a>
        </p>
